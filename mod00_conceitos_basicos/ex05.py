salario_bruto = float(input('Digite seu salário bruto para realizar o cálculo: '))
salario_liquido = 0
...
print(f'Seu salário líquido já deduzidos os impostos será de {salario_liquido:.2f}')
